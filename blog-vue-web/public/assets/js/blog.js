/* 鼠标点击文字特效 */
let font = new Array("富强", "民主", "文明", "和谐", "自由", "平等", "公正", "法治", "爱国", "敬业", "诚信", "友善");
let color = new Array('#ff0000', '#eb4310', '#fbb417', '#ffff00', '#cdd541', '#99cc33', '#3f9337',
    '#219167', '#24998d', '#1f9baa', '#0080ff', '#3366cc', '#333399', '#003366', '#800080', '#a1488e',
    '#c71585', '#bd2158', '#eec142', );
let f_idx = Math.floor(Math.random() * 20) % font.length;
jQuery(document).ready(function($) {
    $("body").click(function(e) {
        let $i = $("<span />").text(font[f_idx]);
